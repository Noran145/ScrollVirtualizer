...
{
    public class BasicSampleView : MonoBehaviour
    {
        [SerializeField] private BasicSampleScrollVirtualizer basicSampleScrollVirtualizer;

        private void Start()
        {
            var list = new List<BasicSampleData>
            {
            ...
            basicSampleScrollVirtualizer.Initialize(list);

            basicSampleScrollVirtualizer.CellButtonClicked += data => Debug.Log(data.CellText);
        }
    }
}
